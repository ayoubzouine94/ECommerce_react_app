                ...
                <div className="w-100">
                    <Row className="justify-content-between">
                        <Col sm="12" className=" d-flex flex-row justify-content-between">
                            <div className="d-inline pt-2 cat-text"> Numero de Commande #2321</div>
                    ...
                    <Row className="justify-content-center mt-2">
                        <Col sm="12" className=" d-flex flex-row justify-content-start">
                            ...
                            iPhone XR, 128 Go, 4G LTE, avec application Face
                                Temps  rouge
                            </div>
                    ...
                    <Row className="justify-content-between">
                        <Col sm="12" className=" d-flex flex-row justify-content-between">
                            ...
                            <div className="d-inline pt-2 barnd-text">12000 Dh </div>
                        </Col>
                    </Row>
                </div>
            </Link>
...
export default AdminAllordersItems